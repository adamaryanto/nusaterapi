...
@section('title', 'Add Membership Tier - Admin Dashboard')
...
@section('content')
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden p-6 md:p-8">
            <form action="{{ route('admin.membership.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" required value="{{ old('name') }}" placeholder="e.g. Silver Member" 
                    ...
                    <div>
                        ...
                        <input type="number" name="price" required value="{{ old('price') }}" placeholder="e.g. 250000" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-gray-50/30">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="discount_wd" required min="0" max="100" value="{{ old('discount_wd', 0) }}" placeholder="e.g. 5" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-gray-50/30">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="discount_we" required min="0" max="100" value="{{ old('discount_we', 0) }}" placeholder="e.g. 5" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-gray-50/30">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="limit_wd" value="{{ old('limit_wd') }}" placeholder="Unlimited if empty" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-gray-50/30">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="limit_we" value="{{ old('limit_we') }}" placeholder="Unlimited if empty" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-gray-50/30">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="window" required min="1" value="{{ old('window', 7) }}" placeholder="e.g. 7" 
                               class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-gray-50/30">
                    </div>
